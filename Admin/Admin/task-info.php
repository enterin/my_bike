...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="col-sm-7">
        <select id="task_title" name="task_title" class="form-control" required>
            ...
            <!-- Add more options as needed -->
                  ...
                  <div class="form-group">
                  <label class="control-label col-sm-5" for="mobile_number">Customer Mobile Number</label>
                  <div class="col-sm-7">
                    <input type="text" name="mobile_number" id="mobile_number" class="form-control" pattern="[0-9]{10}" required>
                    <span class="error-message">Please enter a 10-digit mobile number.</span>
                  </div>
                </div>
                                
                  <div class="form-group">
  <label class="control-label col-sm-5" for="bike_model_select">Bike Model</label>
  <div class="col-sm-7">
    <select name="bike_model" id="bike_model_select" class="form-control">
      <option value="Hero Splendor">Hero Splendor</option>
      <option value="Bajaj Pulsar">Bajaj Pulsar</option>
      <option value="Royal Enfield Classic">Royal Enfield Classic</option>
      <option value="TVS Apache">TVS Apache</option>
      <option value="Honda CB Shine">Honda CB Shine</option>
      <option value="Suzuki Gixxe">Suzuki Gixxer</option>
      <option value="Yamaha FZ">Yamaha FZ</option>
      <option value="Kawasaki Ninja">Kawasaki Ninja</option>
      <option value="Mahindra Mojo">Mahindra Mojo</option>
