...
<div class="row">
	<div class="col-md-4 col-md-offset-3">
		...
		<center><img src="bike.jpg" alt="Bike Logo" style="height: 100px; width: 100px; margin-bottom: 15px;">
		<style>
...
<h2 class="custom-heading" style="margin-top: 1px;">BSM Admin(Employee Task Management)</h2>
</center>
