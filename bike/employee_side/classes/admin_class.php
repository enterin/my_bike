...
/* -------------admin_password_change------------*/
	...
	public function add_new_task($data){
		...
		$bikeModel = $this->test_form_input_data($data['t_bike_model']);
		$mobileNo = $this->test_form_input_data($data['t_mobile_number']);

		try{
			$add_task = $this->db->prepare("INSERT INTO task_info (t_title, t_description, t_start_time, t_end_time, t_user_id, t_bike_model, t_mobile_number) VALUES (:x, :y, :z, :a, :b, :c, :d) ");
			...
			$add_task->bindparam(':c', $mobileNo);
			$add_task->bindparam(':d', $bikeModel);
