              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" placeholder="mobile number" id="t_mobile_number" name="mobile_number" list="expense" class="form-control" id="default" required>
                    </div>
                  </div>
                
                  <div class="form-group">
                    <label class="control-label col-sm-5">Bike Model</label>
                    <div class="col-sm-7">
                      <input type="text" placeholder="bike model" id="t_bike_model" name="mobile_number" list="expense" class="form-control" id="default" required>
                    </div>
                  </div>
                  <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom">
          ...
          <center ><h3>Task Assign Section</h3></center>
              ...
              <tbody>
                      ...
                      <?php
                            ...
                            try {
                                ...
                                $sql = "SELECT task_id, t_title, t_description, t_start_time, t_end_time, t_bike_model, t_mobile_number
                                        FROM task_info WHERE t_user_id = $user_id ";
                                ...
                                if (count($result) > 0) {
                                  ...
                                  foreach ($result as $row) {
                                      ...
                                      <tr>
                                          ...
                                          <td><?php echo $row['t_bike_model']; ?></td>
                                          <td><?php echo $row['t_mobile_number']; ?></td>
                                      </tr>
                                      <?php
                                  }
                              } else {
                ...
                <!-- <tr>
                  ...
                  ?></td>
                  <td><?php 
                  // echo $row['t_start_time']; 
                  ?></td>
                  <td><?php 
                  // echo $row['t_mobile_number']; 
                  ?></td>
                  <td><?php 
                  // echo $row['t_bike_model'];
                   ?></td>
                  <td><?php 
                  // echo $row['t_end_time']; 
                  ?></td>
                 ...
                 <td><a title="Update Task"  href="edit-task.php?task_id=<?php 
                //  echo $row['task_id'];
                 ?>"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
                  <a title="View" href="task-details.php?task_id=<?php
                  //  echo $row['task_id'];
                  ...
                  <a title="Delete" href="?delete_task=delete_task&task_id=<?php 
                  // echo $row['task_id']; 
                  ?>" onclick=" return check_delete();"><span class="glyphicon glyphicon-trash"></span></a></td>
                <?php
                //  } 
